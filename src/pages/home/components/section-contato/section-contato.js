            ...
            <Row>
                <Col m={12} s={12}>
                    ...
                    <div className="sc-icons">
                        <i className="material-icons">email</i> <p>advocacia.adv.br</p>
                        <i className="material-icons">local_phone</i> <p>(21)99999-8787</p>
                        <i className="material-icons">location_on</i> <p>Rua dos arcos imaginários, n233, Casa Boa - RJ</p>
                    </div>
                </Col>
            </Row>
        </div>
